<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Data Pemeriksaan <?= $user->nama_klinik ?></h1>
    </div><!-- End Page Title -->
                            ...
                            <table id="example" class="table datatable table-striped my-4">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-sortable="false">Informasi Pemeriksaan</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?= base_url() ?>perawat/tambah_pemeriksaan" method="post">
                                                    <input type="hidden" name="id_pendaftaran" value="<?= $data->keluhan_umum  ?>">
                                                    <input type="hidden" name="nomor_antri" value="<?= $data->keluhan_umum  ?>">
                                                    <button type="submit" class="btn btn-primary" style="width: 100%;">
