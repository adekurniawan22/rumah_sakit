                    ...
                    <div class="card-body mt-4">
                        <form role="form" action="<?= base_url() ?>admin/proses_edit_pegawai" method="post">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" name="id_pegawai" value="<?= $editPegawai[0]->id_pegawai ?>">
                                    <select class="form-select" aria-label="Default select example" name="role" id="roleSelect" value="<?php echo set_value('role'); ?>">
                                        <option value="" selected>Pilih Role</option>
                                        <option value="2" <?php echo set_select('role', '2', $editPegawai[0]->id_role == '2'); ?>>Petugas Pendaftaran</option>
                                        <option value="3" <?php echo set_select('role', '3', $editPegawai[0]->id_role == '3'); ?>>Perawat</option>
                                        <option value="4" <?php echo set_select('role', '4', $editPegawai[0]->id_role == '4'); ?>>Dokter</option>
                                        <option value="5" <?php echo set_select('role', '5', $editPegawai[0]->id_role == '5'); ?>>Kasir</option>
                                        <option value="6" <?php echo set_select('role', '6', $editPegawai[0]->id_role == '6'); ?>>Rekam Medis</option>
                                        <option value="7" <?php echo set_select('role', '7', $editPegawai[0]->id_role == '7'); ?>>Farmasi</option>
                                    </select>
                            ...
                            <fieldset class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status_aktif" id="gridRadios1" value="1" <?php echo ($editPegawai[0]->status_aktif == 1) ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="gridRadios1">
                                            Aktif
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status_aktif" id="gridRadios2" value="0" <?php echo ($editPegawai[0]->status_aktif == 0) ? 'checked' : ''; ?>>
