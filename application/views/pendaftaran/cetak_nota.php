...
<body>
    <div class="nota-container">
        ...
        <h3 class="text-center mb-5">Nota Pembayaran Pemeriksaan</h3>
        <table>
            <tr>
                <td style="width: 60%;">
            ...
            <tr>
                <td>
                    <span>Biaya Pemereiksaan</span>
                </td>
                <td>
                    <span style="margin-right: 10px;">:</span>
                </td>
                <td>
                    <span>Rp. <?= number_format($nota[0]->harga_biaya, 0) ?></span>
                </td>
            </tr>
        </table>
        <?php
