            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body mt-4">
                        ...
                        <form role="form" action="<?= base_url() ?>kasir/proses_edit_profil" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a class="btn btn-primary" href="<?= base_url() ?>kasir/profil">Kembali</a>
