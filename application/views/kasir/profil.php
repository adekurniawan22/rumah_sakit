                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <a href="<?= base_url() ?>kasir/edit_profil" class="btn btn-primary">Edit Data <i class="bi bi-pencil-square"></i></a>
                                <a href="<?= base_url() ?>kasir/ganti_password" class="btn btn-primary">Ganti Password <i class="bi bi-key-fill"></i></a>
                            </div>
                        </div>
